    ...
    namespace NLZMA
    {
        ...
        HRESULT CEncoder::GetOptimum(UInt32 position, UInt32 &backRes, UInt32 &lenRes)
        {
            ...
            _optimum[1].Price = _isMatch[_state.Index][posState].GetPrice0() + 
                                _literalEncoder.GetPrice(position, _previousByte,
                                                         !_state.IsCharState(), matchByte, currentByte);
            ...
            while(true)
            {
                ...
                UInt32 curAnd1Price = curPrice +
                                      ...
                                      _literalEncoder.GetPrice(position, data[(size_t)0 - 1],
                                                               !state.IsCharState(), matchByte, currentByte);
                ...
                if (numAvailableBytes >= 3 && !nextIsChar)
                {
                    ...
                    if (lenTest2 >= 2)
                    {
                                                   ...
                                                   _isRep[state2.Index].GetPrice1();
                        {
                            ...
                            UInt32 curAndLenPrice = nextRepMatchPrice + GetRepPrice(0,
                        ...
                        if (_maxMode)
                        {
                            ...
                            if (lenTest2 >= 2)
                            {
                                ...
                                UInt32 curAndLenCharPrice = curAndLenPrice + 
                                                            ...
                                                            _literalEncoder.GetPrice(position + lenTest,
        ...
        HRESULT CEncoder::ReadMatchDistances(UInt32 &lenRes)
        {
            ...
            {
                lenRes += _matchFinder->GetMatchLen(lenRes, _matchDistances[lenRes], kMatchMaxLen - lenRes);
            }
            _additionalOffset++;
            ...
            for (UInt32 lenToPosState = 0; lenToPosState < kNumLenToPosStates; lenToPosState++)
            {
                ...
                for (; posSlot < _distTableSize; posSlot++)
                {
                    _posSlotPrices[lenToPosState][posSlot] = _posSlotEncoder[lenToPosState].GetPrice(posSlot) + 
                                                             ...
                                                             NRangeCoder::kNumBitPriceShiftBits);
                }
            }
        }
