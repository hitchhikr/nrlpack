...
namespace PAT_NAMESPACE
{
    ...
    union CDescendant 
    {
        ...
        bool IsEmpty() const
        {
            return NodePointer == kDescendantEmptyValue;
        }
        bool IsNode() const
        {
            return NodePointer < kDescendantEmptyValue;
        ...
        void MakeEmpty()
        {
            NodePointer = kDescendantEmptyValue;
        }
    };
    ...
    private:
                         ...
                         UInt32 aNumSameBits, UInt32 aPos, UInt32 aDescendantIndex)
        {
            ...
            aNewNode->Descendants[aBitsNew].MatchPointer = aPos + kMatchStartValue;
            aNewNode->Descendants[aBitsOld].MatchPointer = aNode->Descendants[aDescendantIndex].MatchPointer;
